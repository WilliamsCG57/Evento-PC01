...
namespace Evento.DOMAIN.Infraestructure.Data;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-Q14I5L6M;Database=EventManagementDB;User=sa;Pwd=123456789;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Attendees>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Attendee__3214EC0772DEA7EC");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__EventAtt__3214EC0710BA3238");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Events__3214EC076480754B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Organize__3214EC07DEA60D38");
